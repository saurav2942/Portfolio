...
library.add(fas, faXmark, faBars, faLinkedinIn, faGithub, faLocationDot);
...
const NavItem = (props) => {
  return (
    <li className="flex jusify-center items-center gap-1 mx-5 md:mx-0 text-gray-700 text-sm hover:text-gray-300">
      <FontAwesomeIcon icon={"fa-solid " + props.type} />
...
const Resume = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <header className="sticky md:relative bg-white md:w-full top-0 z-50 sm:px-16 px-0 flex justify-center items-center md:shadow-none shadow">
              ...
              <div>
                ...
                >
                  <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                    <NavItem name="Home" item="fa-house" />
                    <Dots />
                    <NavItem name="Resume" item="fa-file" />
                    <Dots />
                    <NavItem name="Projects" item="fa-diagram-project" />
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div className="leading-[1] mt-6 max-w-screen-lg md:flex mx-auto">
        <div className="md:w-1/3 p-2">
          <div class="md:block ">
            <img class="h-20 w-20 mx-auto rounded-lg " src={Icon}></img>
            <div class="mb-12 text-center mt-4 justify-center items-left mx-4 text-Inconsolata">
              <h1 class="text-xl text-gray-700 font-bold text-Inconsolata">
                Saurav Mathuriya
              </h1>
              <div class="md:text-sm text-gray-600">Software Engineer</div>
            </div>
          </div>
